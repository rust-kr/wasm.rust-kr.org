...
Rust 스탠다드 라이브러리의 [`Display`] 트레이트를 구현해서 사람이 읽기 쉬운 방식으로 포맷할수 있도록 메소드를 추가해봅시다. 이 트레이트를 구현하면 자동적으로 Universe의 인스턴스(instance)들이 [`to_string`] 메소드를 사용할수 있게 됩니다.
...
마침내, `render` 메소드와 함께 생성자를 정의해서 세포들이 살아나고 죽어가는 신기한 세상을 생성할 수 있도록 해보겠습니다.
